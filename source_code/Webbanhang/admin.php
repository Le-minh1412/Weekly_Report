...
if (!isset($_SESSION['user']) || $_SESSION['user']['user_type'] != 1) {
    header("Location: ../login.php");  // hoặc trang khác
    exit;
}
?>
<!DOCTYPE html>
    ...
    <div class="container">
        ...
        <main class="content">
            <div class="section active">
                <h1 class="page-title">Trang tổng quát của cửa hàng Minh Food</h1>
                <div class="cards">
            ...
            <div class="form-content sign-up">
                <form action="" class="signup-form">
                    <div class="form-group">
                        ...
                        <input id="fullname" name="fullname" type="text" placeholder="VD: Lê Minh" class="form-control">
