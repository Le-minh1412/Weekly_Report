...
<body>
            ...
            <div class="container">
                <div class="header-middle-left">
                    <div class="header-logo">
                        <a href="">
                            <img src="./assets/img/logo.png" alt="" style="height: 40px;width: 100px; ">
                        </a>
                    </div>
                </div>
    ...
    <nav class="header-bottom">
        <div class="container">
            <ul class="menu-list">
                ...
                <li class="menu-list-item" onclick="showNews()"><a href="javascript:;" class="menu-link">Tin tức</a></li>
                <li class="menu-list-item" onclick="showContact()"><a href="javascript:;" class="menu-link">Liên hệ</a></li>
            </ul>
        </div>
    </nav>
    ...
    <main id="main-content" class="main-wrapper">
        <div class="container" id="trangchu">
            <div class="home-slider">
                <div class="box-left">
                    ...
                    <p><br>Chúng tôi mang đến những món ăn không chỉ ngon mà còn đảm bảo chất lượng. Từ nguyên liệu tươi sạch, mỗi món đều được chế biến tỉ mỉ, giữ trọn hương vị tự nhiên</p>
                    <p><br>Minh Food – nơi ẩm thực gặp gỡ sự tinh tế. Mỗi bữa ăn là một trải nghiệm đầy cảm xúc, mang đậm hồn Việt và sự tận tâm trong từng chi tiết.</p>
                </div>
                <div class="box-right">
                    <img src="./assets/img/anh-banner1.jpg" >
                    <img src="./assets/img/anh-banner2.jpg" class="middle-img">
        ...
        <!--Tin tức-->
        <div id="news-section" class="hide">
        </div>
        <!--Liên hệ-->
            ...
            <div class="footer-top">
                <div class="footer-top-content">
                    <div class="footer-top-img">
                        <img src="./assets/img/logo.png" alt="" style="height: 80px;">
                    </div>
                ...
                <div class="widget-row">
                    <div class="widget-row-col-1">
                        ...
                        <div class="widget-row-col-content">
                            <p>Minh Food là thương hiệu được thành lập vào năm 2025 với tiêu chí đặt chất lượng sản phẩm lên hàng đầu.</p>
                        </div>
                        ...
                        <div class="contact">
                            <div class="contact-item">
                                ...
                                <div class="contact-content">
                                    <span>273 Tân Triều , huyện Thanh Trì , TP Hà Nội</span>
                                </div>
                            </div>
                            <div class="contact-item">
                                <div class="contact-item-icon">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-content conatct-item-email">
                                    <span>minh@gmail.com</span><br />
                                    <span>minh2@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="copyright-content">
                <p>Copyright 2025 Minh Food. All Rights Reserved.</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="checkout-col-content">
                        ...
                        <div class="content-group" id="tudenlay-group">
                            ...
                            <div class="delivery-time">
                                ...
                                <label for="chinhanh-1">273 Tân Triều , Thanh Trì , Hà Nội</label>
                            </div>
                            <div class="delivery-time">
                                <input type="radio" name="chinhanh" id="chinhanh-2" class="radio">
                                <label for="chinhanh-2">04 Hà Đông , Hà Nội</label>
                            </div>
                        </div>
                        <div class="content-group">
